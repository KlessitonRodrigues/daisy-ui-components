...
const appName = 'daisyui-storybook';
const appPath = '../storybook-static';
...
class WebsiteStack extends cdk.Stack {
  constructor(scope: cdk.App, id: string, props?: cdk.StackProps) {
    ...
    const websiteBucket = new s3.Bucket(this, `${appName}-bucket`, {
    ...
    const rewriteFunction = new cloudfront.Function(this, `${appName}-rewrite-function`, {
      code: cloudfront.FunctionCode.fromInline(`
        ...
        `),
      comment: `URL rewrite for ${appName} static export`,
    });
    ...
    const distribution = new cloudfront.Distribution(this, `${appName}-distribution`, {
      ...
      comment: `${appName} Static Website`,
    });
    ...
    new cdk.CfnOutput(this, `${appName}-distribution-domain-name`, {
      value: distribution.distributionDomainName,
      description: 'CloudFront Distribution Domain Name',
      exportName: `${appName}DomainName`,
    });

    new cdk.CfnOutput(this, `${appName}-distribution-url`, {
      value: `https://${distribution.distributionDomainName}`,
      description: 'CloudFront Distribution URL',
      exportName: `${appName}-URL`,
    });

    new cdk.CfnOutput(this, `${appName}-bucket-name`, {
...
new WebsiteStack(app, `${appName}-stack`);
